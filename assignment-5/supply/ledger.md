...
|------|------:|-------:|------------:|:--------------:|--------------|
| web | 30% | 1200 | 20300 | 1.00 | 0.06 epochs of 20300B |
| code | 22% | 880 | 1813 | 1.00 | 0.49 epochs of 1813B |
| math_stem | 10% | 400 | 143 | 1.00 | 2.8 epochs of 143B |
| reasoning_traces | 6% | 240 | 38 | 1.00 | 4.0 epochs of 38B; **88B generated** |
...
**Total tokens that must be generated across all lanes: ~238B (5.9% of budget)** - dominated by **agentic** and **reasoning**, where real supply barely exists (long-context is met at 1 epoch, but ~60% of that supply is itself synthetic).
